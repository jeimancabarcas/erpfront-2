      ...
      <header class="flex justify-between items-center mb-6 px-4">
        <div>
          ...
          <p class="text-gray-500 font-medium">
            {{
              isEdit
                ? 'Modifique los datos necesarios del paciente'
                : 'Complete los pasos para dar de alta al nuevo paciente'
            }}
          </p>
        </div>
        <button
          ...
          <form [formGroup]="personalForm" class="py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <ui-text-input
                ...
                [required]="true"
                [formControl]="personalForm.controls.firstNames"
              />
              <ui-text-input
                label="Apellidos"
                icon="person"
                ...
                [required]="true"
                [formControl]="personalForm.controls.lastNames"
              />

              <ui-datepicker
                label="Fecha de Nacimiento"
                [formControl]="personalForm.controls.birthDate"
              />

              <ui-select
                label="Sexo"
                [options]="genderOptions"
                [formControl]="personalForm.controls.gender"
              />

              <ui-select
                label="Tipo de Identificación"
                [options]="idTypeOptions"
                [formControl]="personalForm.controls.idType"
              />
              ...
              <ui-text-input
                ...
                [required]="true"
                [formControl]="personalForm.controls.idNumber"
              />
            </div>
          ...
          <form [formGroup]="locationForm" class="py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <ui-text-input
                ...
                [required]="true"
                [formControl]="locationForm.controls.address"
                class="md:col-span-2"
              />
              <ui-text-input
                label="Ciudad"
              ...
              <ui-select
                label="Zona"
                [options]="zoneOptions"
                [formControl]="locationForm.controls.zone"
              />

              <ui-text-input
                label="Código Postal"
                placeholder="Opcional"
                [formControl]="locationForm.controls.postalCode"
              />
            </div>
          ...
          <form [formGroup]="healthForm" class="py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <ui-text-input
                ...
                [required]="true"
                [formControl]="healthForm.controls.eps"
              />

              <ui-select
                label="Régimen de Salud"
                [options]="healthRegimeOptions"
                [formControl]="healthForm.controls.healthRegime"
              />

              <ui-text-input
                label="Clínica o Lugar donde nació"
                icon="local_hospital"
                placeholder="Ej. Clínica del Country"
                [required]="true"
                [formControl]="healthForm.controls.birthPlace"
                class="md:col-span-2"
              />
          ...
          <form [formGroup]="familyForm" class="py-6">
            ...
            <div class="space-y-6">
              ...
              <div class="bg-gray-50 p-4 rounded-2xl">
                <h3
                  class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4 flex items-center"
                >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
                  <ui-text-input
                    ...
                    icon="person"
                    [formControl]="familyForm.controls.fatherName"
                  />
                  <ui-text-input
                    label="Celular"
                    icon="phone"
                    [formControl]="familyForm.controls.fatherPhone"
                  />
                  <ui-text-input
                    label="Email"
                    type="email"
                    icon="email"
                    [formControl]="familyForm.controls.fatherEmail"
                  />
                  <ui-text-input
                    label="Ocupación"
                    [formControl]="familyForm.controls.fatherOccupation"
                  />
                </div>
              </div>
              ...
              <div class="bg-gray-50 p-4 rounded-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
                  <ui-text-input
                    ...
                    icon="person"
                    [formControl]="familyForm.controls.motherName"
                  />
                  <ui-text-input
                    label="Celular"
                    icon="phone"
                    [formControl]="familyForm.controls.motherPhone"
                  />
                  <ui-text-input
                    label="Email"
                    type="email"
                    icon="email"
                    [formControl]="familyForm.controls.motherEmail"
                  />
                  <ui-text-input
                    label="Ocupación"
                    [formControl]="familyForm.controls.motherOccupation"
                  />
                </div>
              </div>
              ...
              <ui-text-input
                label="Hermanos"
                placeholder="Nombres de los hermanos (opcional)"
                [formControl]="familyForm.controls.siblings"
              />
            </div>
          ...
          <form [formGroup]="birthForm" class="py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <ui-text-input
                ...
                icon="monitor_weight"
                placeholder="Ej. 3200"
                [formControl]="birthForm.controls.birthWeight"
              />
              <ui-text-input
                ...
                icon="straighten"
                placeholder="Ej. 50"
                [formControl]="birthForm.controls.birthHeight"
              />
            </div>
            ...
            <div class="bg-blue-50 border border-blue-100 p-6 rounded-2xl mt-8 flex gap-4">
              ...
              <div>
                ...
                <p class="text-blue-700 text-sm">
                  {{
                    isEdit
                      ? 'Al hacer clic en "Guardar Cambios", se actualizarán los datos del paciente en el sistema.'
                      : 'Al hacer clic en "Finalizar", el paciente será registrado en el sistema y estará disponible para consultas y citas médicas.'
                  }}
                </p>
              </div>
            </div>
