      ...
      <div class="p-8 relative z-10">
        <header class="flex flex-col items-center text-center mb-8">
          <div class="w-16 h-16 bg-red-100 text-red-600 rounded-2xl flex items-center justify-center shadow-lg shadow-red-100 mb-6">
            <span class="material-icons !text-[32px] !w-8 !h-8">warning_amber</span>
          </div>
        ...
        <div class="space-y-4 mb-8">
          <div class="p-4 bg-gray-50 rounded-2xl border border-gray-100 space-y-3">
            <div class="flex gap-3">
              <span class="material-icons text-red-500 !text-[20px] !w-5 !h-5">monetization_on</span>
              <p class="text-xs text-gray-600 leading-relaxed font-medium">
                Se deberá realizar la **devolución de dinero** al paciente por concepto de copago/consulta.
              </p>
            </div>
            <div class="flex gap-3">
              <span class="material-icons text-amber-500 !text-[20px] !w-5 !h-5">receipt_long</span>
              <p class="text-xs text-gray-600 leading-relaxed font-medium">
            ...
            @if (!data().appointment.isParticular) {
              <div class="flex gap-3">
                <span class="material-icons text-blue-500 !text-[20px] !w-5 !h-5">outbox</span>
                <p class="text-xs text-gray-600 leading-relaxed font-medium">
        ...
        <div class="flex flex-col gap-3">
          <button 
            class="!rounded-full !h-14 !font-black !bg-red-600 text-white shadow-xl shadow-red-100 hover:bg-red-700 transition-colors"
            (click)="close(true)"
          >
            Sí, Anular y Devolver
          </button>
          <button 
            class="!rounded-full !h-12 !font-bold text-gray-500 hover:bg-gray-50 transition-colors"
            (click)="close(false)"
          >
            Mantener Cita
          </button>
