...
export class PaymentMethodsService {
  ...
  private apiUrl = `${environment.apiUrl}/settings/payment-methods`;

  private _data = signal<PaymentMethod[]>([]);
  ...
  loadData(params?: QueryParams): Observable<any> {
    ...
    return this.http.get<any>(this.apiUrl, { params: httpParams }).pipe(
      ...
      catchError((err) => {
        this._error.set(err.statusText || 'Error loading payment methods');
