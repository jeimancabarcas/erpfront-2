...
- [ ] 4.1 Run `npm run test -- --watch=false` — all unit tests pass (⚠️ Pre-existing failure in `sale-form.component.spec.ts` blocks the full suite; new datepicker tests compile)
